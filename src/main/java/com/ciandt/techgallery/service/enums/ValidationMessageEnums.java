...
public enum ValidationMessageEnums {
  ...
  TECHNOLOGY_ID_CANNOT_BLANK("Proposal or proposal's id cannot be null or blank."),
  TECHNOLOGY_NAME_CANNOT_BLANK("Proposal's name cannot be null or blank."),
  TECHNOLOGY_CLIENT_CANNOT_BLANK("Proposal's client cannot be null or blank."),
  TECHNOLOGY_OFFER_CANNOT_BLANK("Proposal's offer cannot be null or blank."),
  TECHNOLOGY_SHORT_DESCRIPTION_BLANK("Proposal's short description cannot be null or blank."),
  TECHNOLOGY_DESCRIPTION_BLANK("Proposal's description cannot be null or blank."),
  TECHNOLOGY_NAME_ALREADY_USED("Proposal already exists with this name."),
  TECHNOLOGY_NOT_EXIST("Proposal doesn't exist."),
  TECHNOLOGY_NAME_CANNOT_CHANGE("Proposal's name cannot be changed."),
  // Message for users
