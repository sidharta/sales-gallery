...
public class EndorsementServiceTest {
	...
	// Logger.getLogger(EndorsementServiceTest.class.getName());
	...
	public void executaAgrupamento()
		...
		List<EndorsementsGroupedByEndorsedTransient> groupEndorsementByEndorsed = service
				.groupEndorsementByEndorsed(endorsements, null);
